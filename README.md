...
![THE NEXT DEBUT](docs/images/nextdebut-main-logo.png)

# NEXTDEBUT

아이돌 육성, 커뮤니티, 소셜 로그인, 결제, AI 보조 기능을 하나로 담은 Spring Boot 기반 웹 프로젝트

[발표 자료 PDF 보기](docs/THE_NEXT_DEBUT.pdf)

</div>

## Overview

NEXTDEBUT는 사용자가 연습생을 성장시키고, 게임 플레이를 통해 재화를 획득하며, 상점과 뽑기 시스템을 활용하고, 커뮤니티 및 개인화 기능까지 함께 이용할 수 있도록 구성한 웹 서비스입니다.

### 핵심 포인트

- 아이돌 연습생 육성 중심의 게임형 서비스
- 일반 로그인과 카카오 / 구글 / 네이버 소셜 로그인 지원
- 상점, 포토카드, 결제까지 연결된 순환형 UX 구조
- 커뮤니티, 팬미팅, 실시간 채팅 등 확장 기능 제공
- Python ML 서버와 연동되는 일부 게임 보조 기능 포함
...
| 게임 | 게임 플레이, 재화 획득, 연습생 성장 시스템 |
| 소비 시스템 | 상점 아이템 구매, 연습생 뽑기, 포토카드 뽑기 |
| 결제 | 카카오페이 기반 재화 충전 |
| 사용자 경험 | 로그인 후 개인화된 기능 및 사용자별 데이터 접근 |
| 부가 기능 | 커뮤니티, 팬미팅, 실시간 채팅, AI 챗봇 |

## 시스템 구성도

![NEXTDEBUT 시스템 구성도](docs/images/system-architecture.png)

## ERD

![NEXTDEBUT 핵심 ERD](docs/images/erd-summary.png)
...
- [THE_NEXT_DEBUT.pdf](docs/THE_NEXT_DEBUT.pdf)
